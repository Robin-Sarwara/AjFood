    ...
    if (result.isConfirmed) {
      ...
      try {
        const response = await axiosInstance.delete(
          `http://localhost:9090/api/products/${id}/question/${questionId}`
        );
  ...
  const handleEdit = async (questionId, index) => {
    ...
    try {
      const response = await axiosInstance.get(
        `http://localhost:9090/api/products/${id}/question/${questionId}/get-answer`
      );
  ...
  const handleAnswer = async (questionId) => {
    ...
    if(editIndex!==null){
      try {
        ...
        const response = await axiosInstance.put(`http://localhost:9090/api/products/${id}/question/${questionId}/update-answer`, payload)
